...
from kb_search.tools.read_file import ReadFileToolConfig, read_file
...
def _identity(monkeypatch):
    ...
    monkeypatch.setattr(
        "kb_search.tools.read_file.get_unique_settings_async",
...
def _patch_search_contents(content: Content):
    return patch(
        "kb_search.tools.read_file.search_contents_async",
...
def _patch_download(data: bytes):
    return patch(
        "kb_search.tools.read_file.download_content_to_bytes_async",
