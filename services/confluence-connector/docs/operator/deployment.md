...
- Verify egress to Confluence endpoints is allowed (Cloud: `api.atlassian.com`, `api.media.atlassian.com`, and `auth.atlassian.com`; Data Center: your instance host)
