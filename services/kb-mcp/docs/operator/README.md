<!-- confluence-page-id: 2744877081 -->
<!-- confluence-space-key: PUBDOC -->

## IT Operator Guide

This section covers everything needed to deploy, configure, and operate `kb-mcp`.

- [Deployment](./deployment.md) - Helm chart, required secrets, PostgreSQL, network policy, and the
