...
const MissedEvent = {
  type: 'unique.outlook-mcp.mail.lifecycle-notification.missed',
  schema: z.object({ subscriptionId: z.string() }),
} as const;
...
const CreatedEvent = {
  type: 'unique.outlook-mcp.mail.change-notification.created',
  schema: z.object({ subscriptionId: z.string(), resource: z.string() }),
} as const;

const UpdatedEvent = {
  type: 'unique.outlook-mcp.mail.change-notification.updated',
  schema: z.object({ subscriptionId: z.string(), resource: z.string() }),
} as const;

const DeletedEvent = {
  type: 'unique.outlook-mcp.mail.change-notification.deleted',
  schema: z.object({ subscriptionId: z.string(), resource: z.string() }),
} as const;
