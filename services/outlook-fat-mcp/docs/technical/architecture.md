...
|----------|------|---------|
| `unique.outlook-fat-mcp.main` | topic | Primary message routing |
| `unique.outlook-fat-mcp.dead` | topic | Failed message storage (DLX) |

| Queue | Purpose |
|-------|---------|
| `unique.outlook-fat-mcp.transcript.change-notifications` | Transcript processing |
| `unique.outlook-fat-mcp.transcript.lifecycle-notifications` | Subscription management |
| `unique.outlook-fat-mcp.dead` | Dead letter collection |
