output "client_id" {
  ...
  value       = azuread_application.outlook_fat_mcp.client_id
}
...
output "service_principal_object_id" {
  ...
  value       = var.service_principal_configuration != null ? azuread_service_principal.outlook_fat_mcp[0].object_id : null
}
...
output "admin_consent_url" {
  ...
  value       = "https://login.microsoftonline.com/organizations/adminconsent?client_id=${azuread_application.outlook_fat_mcp.client_id}"
}
