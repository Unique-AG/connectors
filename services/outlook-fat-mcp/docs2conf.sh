...
# SPDX-SnippetEnd
# This script publishes the outlook-fat-mcp docs to Confluence using md2conf.
...
docker run --rm \
    ...
    --generated-by 'This pages are auto-generated from the <a href="https://github.com/unique-ag/connectors/tree/main/services/outlook-fat-mcp/docs">outlook-fat-mcp docs</a>.' \
    ./
