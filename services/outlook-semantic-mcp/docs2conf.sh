...
# SPDX-SnippetEnd
# This script publishes the outlook-semantic-mcp docs to Confluence using md2conf.
...
docker run --rm \
    ...
    --generated-by 'This pages are auto-generated from the <a href="https://github.com/unique-ag/connectors/tree/main/services/outlook-semantic-mcp/docs">outlook-semantic-mcp docs</a>.' \
    ./
