...
| **Used For** | Calendar tools (`list_calendars`, `search_calendar_events`, `check_availability`, `suggest_meeting_times`, and later writes). Live Graph query-through; no calendar ingest |
