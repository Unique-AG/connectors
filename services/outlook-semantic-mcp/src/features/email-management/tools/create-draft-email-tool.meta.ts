  ...
  systemPrompt: `### When to Use \`create_draft_email\` Tool
    ...
    **Do not ask the user for confirmation before searching.** Act immediately.
    ...
    - \`data\`: a URI identifying the file content. Supported URI schemes:
      - **Unique content**: \`unique://content/{contentId}\` — attach a file from the Unique knowledge base using its chat ID and content ID. Example: \`unique://content/cont_j23i0ifr44sdn7cz97ubleb7\`.
