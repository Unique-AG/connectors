...
function createMockClient(graphApi: ReturnType<typeof createMockGraphApi>) {
  return { api: vi.fn().mockReturnValue(graphApi) };
}
...
function createCommand({
  ...
  return { command, client: createMockClient(graphApi) };
}
