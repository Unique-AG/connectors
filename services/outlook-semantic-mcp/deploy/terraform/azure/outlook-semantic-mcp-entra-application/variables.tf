...
variable "redirect_uris" {
  description = "List of OAuth redirect URIs for the application. Must include the callback URL(s) for your Outlook Semantic MCP server(s). At least one URI is required — omitting it causes AADSTS500113 at runtime."
  type        = list(string)
