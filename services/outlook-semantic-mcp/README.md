...
| `LOG_BUFFERING` | `disabled` | Buffer logs before writing to reduce I/O (enabled/disabled) |
| `LOG_DIAGNOSTICS_DATA_POLICY` | `conceal` | Controls what diagnostic data is logged (conceal/expose) |
