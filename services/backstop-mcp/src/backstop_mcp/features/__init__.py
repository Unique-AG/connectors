...
schema discovery (`custom_fields`), name-to-record lookup (`party_resolver`), the shared
entity-type vocabulary (`entity_types`), and the resolution algebra the latter two share
(`resolution`).
