...
from backstop_mcp.custom_fields.lov import inline_allowed_values
from backstop_mcp.custom_fields.service import CustomFieldsService, create_custom_fields_service
...
from backstop_mcp.resolution import Resolved
...
class TestSnapshotCodec:
    ...
    async def test_round_trips_allowed_values_and_lov_set_id(self, db: DatabaseFixture) -> None:
        from backstop_mcp.custom_fields.types import AllowedValue
