...
import { type FetchFn, pipeline, withBaseUrl, withHeaders, withResponseError } from '@qfetch/qfetch';
...
@Module({
  ...
  exports: [UNIQUE_FETCH, UniqueService, UniqueContentService, UniqueUserService, UniqueScopeService],
})
