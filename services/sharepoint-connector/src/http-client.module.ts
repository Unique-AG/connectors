...
import {
  SHAREPOINT_HTTP_CLIENT,
  SHAREPOINT_V1_HTTP_CLIENT,
  UNIQUE_HTTP_CLIENT,
} from './http-client.tokens';
...
@Module({
  ...
  providers: [
    ...
    {
      provide: SHAREPOINT_V1_HTTP_CLIENT,
      useFactory: () => {
        return new Client('https://uniqueapp.sharepoint.com', {
          bodyTimeout: 30000,
          headersTimeout: 5000,
        });
      },
  ...
  exports: [UNIQUE_HTTP_CLIENT, SHAREPOINT_HTTP_CLIENT, SHAREPOINT_V1_HTTP_CLIENT],
})
