...
| connectorConfig.unique.permissionsInheritanceMode | string | `"inherit_scopes_and_files"` | Inheritance mode for scopes and files in content_only mode. Allowed values: inherit_scopes_and_files, inherit_scopes, inherit_files, none. Ignored in content_and_permissions. |
