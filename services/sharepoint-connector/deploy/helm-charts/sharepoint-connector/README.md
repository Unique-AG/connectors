...
| connectorConfig.unique.scopeGenerationInheritAccess | bool | `null` | Whether scopes generated from paths inherit access from their parent scope. If unset, inheritance is enabled for content_only sync mode and disabled for content_and_permissions. |
