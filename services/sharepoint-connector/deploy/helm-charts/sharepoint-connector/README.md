...
| connectorConfig.unique.scopeGenerationInheritAccess | string | `null` | Whether scopes generated from paths inherit access from their parent scope. Allowed values: inherit, do_not_inherit. If unset, inheritance is enabled for content_only sync mode and disabled for content_and_permissions. |
