...
| connectorConfig.sharepoint.auth.clientId | string | `"unset_default_value"` | Azure AD application client ID example: 00000000-0000-0000-0000-000000000000 The matching secret must be sourced from a secret |
