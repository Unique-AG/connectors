...
CREATE TABLE "delta_state" (
	...
	"created_at" timestamp DEFAULT now() NOT NULL,
	"updated_at" timestamp DEFAULT now() NOT NULL,
	CONSTRAINT "delta_state_userProfileId_unique" UNIQUE("user_profile_id")
);
--> statement-breakpoint
...
ALTER TABLE "delta_state" ADD CONSTRAINT "delta_state_user_profile_id_user_profiles_id_fk" FOREIGN KEY ("user_profile_id") REFERENCES "public"."user_profiles"("id") ON DELETE cascade ON UPDATE cascade;--> statement-breakpoint
