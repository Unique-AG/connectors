...
@Injectable()
export class IndexActivity implements OnModuleInit {
  ...
  public async onModuleInit() {
    const index = async (_ctx: WorkflowActivityContext, payload: IndexPayload) => {
      return this.index(payload);
    };
    this.runtime.registerActivity(index);
  }
