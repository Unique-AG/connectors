...
Users sign in with their own Microsoft account and the server acts as them. It exposes thirteen
...
tree — each one a file of its own,
...
| `Mail.Read` | Delegated | No | `outlook_search_mail`, `outlook_read_mail`, `outlook_browse_folders` |
...
| `outlook-read` | find a message in your own mailbox, read it in full, and walk the folder tree | `outlook_search_mail`, `outlook_read_mail`, `outlook_browse_folders` | `User.Read`, `Mail.Read` | 0 |
