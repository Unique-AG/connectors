...
nothing. Before you report that somebody did not speak, read that flag. Transcripts above \
{MAX_TRANSCRIPT_BYTES // (1024 * 1024)} MB are refused rather than read in part, and no argument \
makes the call smaller. Returns turns with speaker, seconds, and text.\
"""
