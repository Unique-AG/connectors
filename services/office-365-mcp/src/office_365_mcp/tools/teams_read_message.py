...
_DESCRIPTION = """\
Reads one Teams message in full: the whole text, sender, @-mentions, attachments, and edit or \
...
teams_browse_channel returned is already complete and needs no read.\
"""
