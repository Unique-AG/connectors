...
from office_365_mcp.graph_client.errors import GraphPagingUnending
from office_365_mcp.graph_client.observability import current_graph_operation, record_pages_scanned
