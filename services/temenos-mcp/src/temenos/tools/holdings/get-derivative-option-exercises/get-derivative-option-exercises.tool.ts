...
import {
  GetDerivativeOptionExercisesInputSchema,
  GetDerivativeOptionExercisesOutputSchema,
  GetDerivativeOptionExercisesQuery,
  type GetDerivativeOptionExercisesResult,
} from './get-derivative-option-exercises.query';
