...
export const GetDerivativeOptionExercisesInputSchema = z.object({
...
export type GetDerivativeOptionExercisesInput = z.infer<typeof GetDerivativeOptionExercisesInputSchema>;

export const GetDerivativeOptionExercisesOutputSchema = z
  .object({
    success: z.boolean(),
...
export type GetDerivativeOptionExercisesResult = z.infer<typeof GetDerivativeOptionExercisesOutputSchema>;

@Injectable()
export class GetDerivativeOptionExercisesQuery {
  private readonly logger = new Logger(GetDerivativeOptionExercisesQuery.name);
  ...
  @Span()
  public async run(input: GetDerivativeOptionExercisesInput): Promise<GetDerivativeOptionExercisesResult> {
    this.logger.debug({}, 'get_derivative_option_exercises: invoked');
    const start = Date.now();
    let result: 'success' | 'error' = 'success';
    try {
      const data = await this.client.get<unknown>('/holdings/instruments/options/exercises', {
      ...
      this.metrics.recordToolDuration('get_derivative_option_exercises', result, start);
    }
  }
}
