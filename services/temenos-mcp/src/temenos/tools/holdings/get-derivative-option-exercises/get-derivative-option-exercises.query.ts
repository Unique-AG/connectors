...
export type GetDerivativeOptionExercisesInput = z.infer<
  typeof GetDerivativeOptionExercisesInputSchema
>;
...
export type GetDerivativeOptionExercisesResult = z.infer<
  typeof GetDerivativeOptionExercisesOutputSchema
>;
...
export class GetDerivativeOptionExercisesQuery {
  ...
  @Span()
  public async run(
    input: GetDerivativeOptionExercisesInput,
