...
import {
  GetDerivativeOptionAssignsInputSchema,
  GetDerivativeOptionAssignsOutputSchema,
  GetDerivativeOptionAssignsQuery,
  type GetDerivativeOptionAssignsResult,
} from './get-derivative-option-assigns.query';
