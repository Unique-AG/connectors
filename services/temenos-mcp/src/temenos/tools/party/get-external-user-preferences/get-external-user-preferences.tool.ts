...
import { GetExternalUserPreferencesInputSchema, GetExternalUserPreferencesOutputSchema, GetExternalUserPreferencesQuery, type GetExternalUserPreferencesResult } from './get-external-user-preferences.query';
