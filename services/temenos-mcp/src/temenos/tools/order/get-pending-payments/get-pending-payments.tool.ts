...
import { GetPendingPaymentsInputSchema, GetPendingPaymentsOutputSchema, GetPendingPaymentsQuery, type GetPendingPaymentsResult } from './get-pending-payments.query';
...
export class GetPendingPaymentsTool {
  ...
  @Tool({
    ...
    description: 'Retrieve pending payment orders from Temenos. Filter by company, date, transaction reference, currency, amount, or account IDs.',
