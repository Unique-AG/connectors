...
class TestAppConfig:
    ...
    def test_rejects_invalid_app_env(self, monkeypatch: pytest.MonkeyPatch) -> None:
...
class TestDatabaseConfig:
    ...
    def test_builds_url_from_individual_parts(self, monkeypatch: pytest.MonkeyPatch) -> None:
    ...
    def test_uses_provided_url_directly(self, monkeypatch: pytest.MonkeyPatch) -> None:
    ...
    def test_adds_asyncpg_driver_if_missing(self, monkeypatch: pytest.MonkeyPatch) -> None:
    ...
    def test_raises_when_no_url_and_no_password(self, monkeypatch: pytest.MonkeyPatch) -> None:
    ...
    def test_raises_when_partial_config(self, monkeypatch: pytest.MonkeyPatch) -> None:
    ...
    def test_uses_default_port_when_not_specified(self, monkeypatch: pytest.MonkeyPatch) -> None:
    ...
    def test_preserves_asyncpg_driver_if_already_present(
    ...
    def test_raises_when_url_is_not_postgres(self, monkeypatch: pytest.MonkeyPatch) -> None:
    ...
    def test_accepts_other_postgres_drivers(self, monkeypatch: pytest.MonkeyPatch) -> None:
...
class TestRabbitMqConfig:
    ...
    def test_raises_when_no_url_and_missing_parts(self, monkeypatch: pytest.MonkeyPatch) -> None:
    ...
    def test_handles_root_vhost(self, monkeypatch: pytest.MonkeyPatch) -> None:
    ...
    def test_raises_when_url_is_not_amqp(self, monkeypatch: pytest.MonkeyPatch) -> None:
    ...
    def test_uses_default_vhost_when_not_specified(self, monkeypatch: pytest.MonkeyPatch) -> None:
    ...
    def test_accepts_amqps_scheme(self, monkeypatch: pytest.MonkeyPatch) -> None:
