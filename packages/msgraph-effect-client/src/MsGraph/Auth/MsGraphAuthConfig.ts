...
export class DelegatedAuthConfig extends ServiceMap.Service<
  DelegatedAuthConfig,
  DelegatedAuthConfigShape
>()('MsGraph/Auth/DelegatedAuthConfig') {}

export class ApplicationAuthConfig extends ServiceMap.Service<
  ApplicationAuthConfig,
  ApplicationAuthConfigShape
>()('MsGraph/Auth/ApplicationAuthConfig') {}

export class OnBehalfOfAuthConfig extends ServiceMap.Service<
  OnBehalfOfAuthConfig,
  OnBehalfOfAuthConfigShape
>()('MsGraph/Auth/OnBehalfOfAuthConfig') {}

export class ManagedIdentityAuthConfig extends ServiceMap.Service<
  ManagedIdentityAuthConfig,
  ManagedIdentityAuthConfigShape
