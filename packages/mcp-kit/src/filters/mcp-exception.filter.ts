 ...
 * (`ToolWireResult`). `McpError` and `UpstreamConnectionRequiredError` are re-thrown so they can
...
export class McpExceptionFilter implements ExceptionFilter {
  ...
  public catch(exception: unknown, _host: ArgumentsHost): ToolWireResult {
